           ...
           function increaseIframeSize(w,h){
            ...
            function newInvite(){
                 var receiverUserIds = FB.ui({ 
                        method : 'apprequests',
                        message: 'Friends check out this app ! http://apps.facebook.com/knowyourcollege',
                 },
	...
	<div class="colmid">
		<div class="colleft">
			...
			<div class="col2">
				...
				<p>Some sample text </p><p>Some sample text </p><p>Some sample text </p>
				<p><img src="http://peeyushchandel.files.wordpress.com/2012/01/3.jpg" alt="" /></p><p><img src="http://peeyushchandel.files.wordpress.com/2012/01/2.jpg" alt="" /></p>
				<p>Some sample text </p><p>Some sample text </p>
			...
			<div class="col3">
				...
				<h2><a href="#" onclick="newInvite(); return false;">Send Request </a></h2>
				<p>Please invite your friends ! .. Help us grow <a href="#" onclick="newInvite(); return false;">Send Request </a> </p>
				<!-- <h2></h2>
				<p>humanitatis per seacula quarta decima et quinta decima. Eodem modo typi, qui nunc nobis videntur parum clari, fiant sollemnes in futurum.</p>
				Column 3 end -->
			</div>
